...
parseInt(a,2)},trunc=function(a,b){if("string"!=typeof a||"number"!=typeof b)throw Error("invalid input to trunc");for(;a.length>b;)a=a.slice(1);return a},binToHex=function(a){if("string"!=typeof a)throw Error("invalid input to binToHex");a=parseInt(a,2);if(NaN==a)throw Error("invalid input to binToHex");return a.toString(16)},mod=function(a,b){if("number"!=typeof a||"number"!=typeof b)throw Error("invalid input to mod");return(a%b+b)%b},padZero=function(a,b){if("number"!=typeof a||"number"!=typeof b)throw Error("invalid input to padZero");
var c=a.toString().split("");if(b<=c.length)throw Error("zero padding failed");for(;c.length<b;)c.unshift("0");return c.join("")};exstat.array={normalize:normalize,median:median,mean:mean};exstat.string={toUTF8Array:toUTF8Array,binAdd:binAdd,binToInt:binToInt,trunc:trunc,binToHex:binToHex};exstat.number={mod:mod,padZero:padZero};module.exports=exstat;
